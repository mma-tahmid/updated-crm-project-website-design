...
import InstallationJobAssignTable from '../UpdatedComponents/StatusCard/InstallationJobAssignTable';

const InstallationJobAssign = () => {
    return (
        <>
            ...
            <div className='conatiner mx-3 mt-2'>
                ...
                <div className='px-6 py-6 shadow-md sm:flex lg:justify-between sm:justify-between'>
                    ...
                    <div className='text-[#E74A3B] sm:text-left text-center text-decoration-1'>Installation Job Assign</div>
                ...
                <div className='sm:flex grid grid-cols-2 gap-y-4 place-items-center sm:justify-center sm:gap-x-4 mt-4 mb-4'>
                    ...
                    <button className='text-[#F9333E] border-2 border-[#F9333E] w-[117px] h-[40px] rounded-[5px]'>Note Add</button>

                    <button className='text-[#F9333E] border-2 border-[#F9333E] w-[117px] h-[40px] rounded-[5px]'>Job Closed</button>
...
export default InstallationJobAssign;