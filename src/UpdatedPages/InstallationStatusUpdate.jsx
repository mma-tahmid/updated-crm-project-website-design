...
import TableInstallationStatusUpdate from '../UpdatedComponents/StatusCard/TableInstallationStatusUpdate';

const InstallationStatusUpdate = () => {
    return (
        <>
            ...
            <div className='conatiner mx-3 mt-2'>
                ...
                <div className='px-6 py-6 shadow-md sm:flex lg:justify-between sm:justify-between border'>
                    ...
                    <div className=' relative text-[#E74A3B] sm:text-left text-center text-decoration-1'>Installation Status Update

                        <div className='invisible sm:visible absolute top-[5px] left-[300px] '> <MdOutlineModeEditOutline className='border-2 border-[#EB5757] text-[#EB5757] rounded-[6px] bg-[#FCEAEA] shadow-lg' /> </div>
                ...
                <div className=' shadow-md  mt-7 '>
                    ...
                    <div className='mt-7 sm:flex sm:justify-between px-3 lg:px-20 pb-16'>
                        <div className='flex gap-x-3'>
                            <DatePicker placeholder='From Date' className='w-[160px]' />
                            <DatePicker placeholder='To Date' className='w-[160px]' />
                        </div>

                        <div className='mt-4 md:mt-0'>
                            <Select placeholder='vendor/Technician' className='w-[150px] md:w-[200px]' />
                        </div>
                ...
                <div className=' shadow-md  mt-7 '>
                    ...
                    <div className='bg-[#FDECEC] py-4 md:py-0 flex sm:flex-row flex-col items-center sm:justify-between pb-4 sm:pb-0'>
                        <div className='sm:py-6 sm:px-10  sm:flex sm:gap-x-3 '>
                            ...
                            {/* <div className='pt-1.5  '> <FaSearch className='text-[#FFF] bg-[#EB5757]'   /></div> */}
                            <div className='  text-[#E74A3B] text-decoration-3 '>Assign Job List
                            </div>
                        </div>
...
export default InstallationStatusUpdate;